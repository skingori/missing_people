...
<div class="callout callout-danger">
    ...
    $result = mysqli_query($con,"SELECT COUNT(Missing_Persons_Id) FROM Missing_Persons_Table WHERE Missing_Persons_Identity='$id'");
...
<div class="callout callout-success">
    ...
    $result = mysqli_query($con,"SELECT COUNT(Handling_Officer_Id) FROM Handling_Officer_Table WHERE Handling_Officer_User_Id='$id'");
    $row1 = mysqli_fetch_array($result);
